...
namespace BancoCRUD.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(BancobdContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<User>> PostUser(User user)
        {
          if (_context.Users == null)
          {
              return Problem("Entity set 'BancobdContext.Users'  is null.");
          }
        ...
        {
            return (_context.Users?.Any(e => e.IdUsuario == id)).GetValueOrDefault();
        }
    }
}
